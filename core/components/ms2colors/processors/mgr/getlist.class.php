...
abstract class ms2ColorsGetListProcessor extends modObjectGetListProcessor
{
    use ms2ColorsProcessorHelperSearchQuery;
    use ms2ColorsProcessorHelperComboQuery;
