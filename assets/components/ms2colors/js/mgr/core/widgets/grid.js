...
ms2Colors.grid.abstract = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        //Custom settings
        url: null,
    ...
    ms2Colors.grid.abstract.superclass.constructor.call(this, config)
};
Ext.extend(ms2Colors.grid.abstract, MODx.grid.Grid, {
    ...
    initComponent: function () {
        ...
        ms2Colors.grid.abstract.superclass.initComponent.call(this);
    },
    ...
    getGridColumn: function (name, config = {}) {
        return ms2Colors.component.gridColumn(name, config);
    },
