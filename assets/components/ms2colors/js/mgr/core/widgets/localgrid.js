...
ms2Colors.localGrid = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        //Custom settings
        fields: [],
    ...
    ms2Colors.localGrid.superclass.constructor.call(this, config);
};
Ext.extend(ms2Colors.localGrid, MODx.grid.LocalGrid, {
    _recordEditWindow: null,

    initComponent: function () {
        this.columns = this._getGridColumns();
        this.tbar = this.getToolbar();
        ms2Colors.localGrid.superclass.initComponent.call(this);
    },
