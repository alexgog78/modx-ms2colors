...
ms2Colors.formPanel.abstract = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        //Custom settings
        url: null,
    ...
    ms2Colors.formPanel.abstract.superclass.constructor.call(this, config);
};
Ext.extend(ms2Colors.formPanel.abstract, MODx.FormPanel, {
    defaultValues: {},
    ...
    initComponent: function () {
        ...
        ms2Colors.formPanel.abstract.superclass.initComponent.call(this);
    },
    ...
    getFormInput: function (name, config = {}) {
        return ms2Colors.component.inputField(name, config);
    },
