...
Ext.namespace('ms2Colors.combo.multiSelectRemote');

ms2Colors.combo.multiSelectRemote.abstract = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        //Custom settings
    ...
    config.name += '[]';
    config.hiddenName += '[]';
    ms2Colors.combo.multiSelectRemote.abstract.superclass.constructor.call(this, config);
};
Ext.extend(ms2Colors.combo.multiSelectRemote.abstract, Ext.ux.form.SuperBoxSelect);
